      ...
      return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                if (authVM.myProduct != null && authVM.myProduct!.isEmpty) Center(child: Text("You can add your products here")),
                if (authVM.myProduct != null) ...authVM.myProduct!.map((e) => ProductWidgetList(context, e))
              ],
            ),
          ),
        ),
